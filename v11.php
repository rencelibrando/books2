...
<footer class="w3-container w3-grey w3-padding-30 w3-center ">  
 ...
 <div class=" w3-light-grey w3-padding-64 w3-container">
    ...
    <form method="post" action="cart1.php">
            <img src="11.png" alt="VB.NET PROGRAMMING FUNDAMENTALS" class="fil-size">
            <h6>VB.NET PROGRAMMING FUNDAMENTALS</h6><h6><b>Stock:</b> <?php echo $row['stock']; ?></h6><h6>₱ 425.00</h6>
