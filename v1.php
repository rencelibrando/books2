 ...
 <div class=" w3-light-grey w3-padding-64 w3-container">
    ...
    <br>  
          <form method="post" action="cart1.php">
            <img src="1.png" alt="Filipino sa Iba't Ibang Disiplina" class="fil-size" style="display: inline-block;">
            <h6>MASTERING COLLEGE ALGEBRA</h6><h6><b>Stock:</b> <?php echo $row['stock']; ?></h6><h6>₱ 280.00</h6>
            <input id="atcn" class="form-control" style="width:25%;border-radius:50px;" type="text" name="qnty" value="1" size="2" />
            <input id="prc" class="form-control"  type="hidden" name="prc" value="270"/>
            <input id="prid" class="form-control"  type="hidden" name="prid" value="1"/>
