...
// fetch product stock
$sql = "SELECT * FROM stock where id = 8";
...
<footer class="w3-container w3-grey w3-padding-30 w3-center ">  
 ...
 <div class=" w3-light-grey w3-padding-64 w3-container">
    ...
    <form method="post" action="cart1.php">
            ...
            <h6>DIFFERENTIAL AND INTEGRAL CALCULUS</h6><h6><b>Stock:</b> <?php echo $row['stock']; ?></h6><h6>₱ 420.00</h6>
            ...
            <input id="prid" class="form-control"  type="hidden" name="prid" value="8"/>
