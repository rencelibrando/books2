...
// fetch product stock
$sql = "SELECT * FROM stock where id = 6";
...
<head>
<meta charset="UTF-8">
<title> Book Store JUNCTION Book Store</title>
...
<footer class="w3-container w3-grey w3-padding-30 w3-center ">  
 ...
 <div class=" w3-light-grey w3-padding-64 w3-container">
    ...
    <form method="post" action="cart1.php">
            ...
            <h6>BASIC FUNDAMENTALS OF STRUCTURAL STEEL DESIGN</h6><h6><b>Stock:</b> <?php echo $row['stock']; ?></h6><h6>₱ 420.00</h6>
            <input id="atcn" class="form-control" style="width:25%;border-radius:50px;" type="text" name="qnty" value="1" size="2"/>
            <input id="prc" class="form-control"  type="hidden" name="prc" value="320"/>
            <input id="prid" class="form-control"  type="hidden" name="prid" value="6"/>
